...
public class Color {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        desktop_macos_h.C_DOUBLE.withName("red"),
        desktop_macos_h.C_DOUBLE.withName("green"),
        desktop_macos_h.C_DOUBLE.withName("blue"),
        desktop_macos_h.C_DOUBLE.withName("alpha")
    ).withName("Color");
