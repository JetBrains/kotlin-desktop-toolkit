...
/**
 * {@snippet lang=c :
 * struct ScreenInfoArray {
 *     struct ScreenInfo *ptr;
 *     ArraySize len;
 * }
 * }
 */
public class ScreenInfoArray {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        desktop_macos_h.C_POINTER.withName("ptr"),
        desktop_macos_h.C_LONG_LONG.withName("len")
    ).withName("ScreenInfoArray");
