...
public class KeyModifiers {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        desktop_macos_h.C_BOOL.withName("capslock"),
        desktop_macos_h.C_BOOL.withName("shift"),
        desktop_macos_h.C_BOOL.withName("control"),
        desktop_macos_h.C_BOOL.withName("option"),
        desktop_macos_h.C_BOOL.withName("command"),
        desktop_macos_h.C_BOOL.withName("numeric_pad"),
        desktop_macos_h.C_BOOL.withName("help"),
        desktop_macos_h.C_BOOL.withName("function")
