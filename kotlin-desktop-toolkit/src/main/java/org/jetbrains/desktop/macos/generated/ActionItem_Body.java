...
public class ActionItem_Body {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        desktop_macos_h.C_BOOL.withName("enabled"),
        MemoryLayout.paddingLayout(7),
        desktop_macos_h.C_POINTER.withName("title"),
        desktop_macos_h.C_BOOL.withName("macos_provided"),
        MemoryLayout.paddingLayout(7),
        desktop_macos_h.C_POINTER.withName("keystroke"),
        desktop_macos_h.C_POINTER.withName("perform")
    ...
    public static class perform {
        ...
        private static final MethodHandle UP$MH = desktop_macos_h.upcallHandle(perform.Function.class, "apply", $DESC);
