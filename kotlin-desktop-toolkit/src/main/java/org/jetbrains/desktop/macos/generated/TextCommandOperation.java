...
/**
 * {@snippet lang=c :
 * struct TextCommandOperation {
 *     WindowId window_id;
 *     ConstStrPtr command;
 * }
 * }
 */
public class TextCommandOperation {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        desktop_macos_h.C_POINTER.withName("command")
    ).withName("TextCommandOperation");
    ...
    private static final long command$OFFSET = 8;
