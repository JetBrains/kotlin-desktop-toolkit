...
public class TextOperationHandler {
    ...
    private static final MethodHandle UP$MH = desktop_macos_h.upcallHandle(TextOperationHandler.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(TextOperationHandler.Function fi, Arena arena) {
