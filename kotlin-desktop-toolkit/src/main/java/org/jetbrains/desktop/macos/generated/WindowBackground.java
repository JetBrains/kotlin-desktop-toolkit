...
public class WindowBackground {
    ...
    private static final GroupLayout solid_color$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$598:3"), groupElement("$anon$599:5"), groupElement("solid_color"));
    ...
    private static final OfInt visual_effect$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$598:3"), groupElement("$anon$602:5"), groupElement("visual_effect"));
