...
public class EventHandler {
    ...
    private static final MethodHandle UP$MH = desktop_macos_h.upcallHandle(EventHandler.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(EventHandler.Function fi, Arena arena) {
