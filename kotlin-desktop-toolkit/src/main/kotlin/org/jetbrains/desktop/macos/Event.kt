...
public sealed class Event {
    public companion object {
         ...
         *
         * When [TextInputSource] is changed programmatically, it suffers from face condition;
         * the result may not reflect the actual input source.
         *
         * Must be called during key event handling.
         * @throws NativeError if called outside an event handler.
