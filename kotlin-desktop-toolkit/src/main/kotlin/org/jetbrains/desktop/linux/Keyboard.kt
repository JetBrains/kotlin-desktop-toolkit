...
public value class KeySym internal constructor(public val value: Int) {
    ...
    public companion object {
        ...
        public const val `0`: RawKeysym = 0x30
        public const val `1`: RawKeysym = 0x31
        public const val `2`: RawKeysym = 0x32
        public const val `3`: RawKeysym = 0x33
        public const val `4`: RawKeysym = 0x34
        public const val `5`: RawKeysym = 0x35
        public const val `6`: RawKeysym = 0x36
        public const val `7`: RawKeysym = 0x37
        public const val `8`: RawKeysym = 0x38
        public const val `9`: RawKeysym = 0x39
