...
public object KotlinDesktopToolkit {
    ...
    private fun libraryName(useDebugBuild: Boolean): String {
        val osName = when (Platform.INSTANCE.type) {
            Platform.Type.Windows -> "windows"
            Platform.Type.Linux -> "linux"
            Platform.Type.MacOS -> "macos"
        ...
        val libName = "desktop_gtk_${osName}_${targetSuffix}$debugSuffix"
