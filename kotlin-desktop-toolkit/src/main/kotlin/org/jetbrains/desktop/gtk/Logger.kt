...
import org.jetbrains.desktop.gtk.generated.NativeExceptionsArray
import org.jetbrains.desktop.gtk.generated.NativeLoggerConfiguration
...
public enum class LogLevel {
    ...
    internal fun toNative(): Int {
        return when (this) {
            Off -> desktop_gtk_h.NativeLogLevel_Off()
            Error -> desktop_gtk_h.NativeLogLevel_Error()
            Warn -> desktop_gtk_h.NativeLogLevel_Warn()
            Info -> desktop_gtk_h.NativeLogLevel_Info()
            Debug -> desktop_gtk_h.NativeLogLevel_Debug()
            Trace -> desktop_gtk_h.NativeLogLevel_Trace()
        }
    }
}
...
private fun checkExceptions(): List<String> {
    return Arena.ofConfined().use { arena ->
        val exceptionsArray = desktop_gtk_h.logger_check_exceptions(arena)
...
internal fun <T> ffiDownCall(body: () -> T): T {
    ...
    if (exceptions.isNotEmpty()) {
        desktop_gtk_h.logger_clear_exceptions()
