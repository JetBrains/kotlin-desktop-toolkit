package org.jetbrains.desktop.linux_x11
...
import org.jetbrains.desktop.linux.generated.NativeFfiWindowCloseRequest
import org.jetbrains.desktop.linux.generated.NativeGetEglProcFuncData
import org.jetbrains.desktop.linux.generated.NativeQueryDragAndDropTarget
...
public class Application : AutoCloseable {
    ...
    public fun runEventLoop(applicationConfig: ApplicationConfig) {
        ...
        ffiDownCall {
            Arena.ofConfined().use { arena ->
                desktop_linux_h.application_run_event_loop(appPtr!!, arena.allocateUtf8String(applicationConfig.appId))
            }
        }
    }
    ...
    public fun requestRedrawDragIcon() {
        ffiDownCall {
            desktop_linux_h.application_request_redraw_drag_icon(appPtr)
        }
    }
}
