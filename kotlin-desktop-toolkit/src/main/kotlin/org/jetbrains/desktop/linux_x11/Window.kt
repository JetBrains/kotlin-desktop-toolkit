...
public class Window internal constructor(
    ...
    public fun showMenu() {
        ffiDownCall {
            desktop_linux_h.window_show_menu(appPtr, windowId)
        }
    }
    ...
    public fun textInputEnable(context: TextInputContext) {
        ffiDownCall {
            Arena.ofConfined().use { arena ->
                desktop_linux_h.window_text_input_enable(appPtr, windowId, context.toNative(arena))
            }
        }
    }
    ...
    public fun textInputUpdate(context: TextInputContext) {
        ffiDownCall {
            Arena.ofConfined().use { arena ->
                desktop_linux_h.window_text_input_update(appPtr, windowId, context.toNative(arena))
            }
        }
    }
    ...
    public fun textInputDisable() {
        ffiDownCall {
            desktop_linux_h.window_text_input_disable(appPtr, windowId)
        }
    }
