...
public enum class PointerShape {
     ...
     *  The program is performing some processing, but is different from [Wait]
     * in that the user may still interact with the program.
     */
    Progress,
     ...
     *
     * Often rendered as a magnifying glass with a "+" in the center of the glass.
     */
    ZoomIn,
