...
group = "org.jetbrains.kotlin-desktop-toolkit-win32"
...
val generateBindingsTaskByOS = allPlatforms.allOSes().associateWith { os ->
    tasks.register<GenerateJavaBindingsTask>("generateBindingsFor${os.getKdtName()}") {
        ...
        generatedSourcesDirectory = layout.buildDirectory.dir("generated/sources/jextract/${os.getKdtName()}/main/java/")
    }
}
...
fun jarSuffixForPlatform(platform: Platform): String {
    val osName = platform.os.getKdtName()
