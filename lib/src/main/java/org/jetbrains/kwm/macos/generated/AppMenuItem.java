...
public class AppMenuItem {
    ...
    private static final GroupLayout action_item$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$77:3"), groupElement("action_item"));
    ...
    private static final GroupLayout sub_menu_item$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$77:3"), groupElement("sub_menu_item"));
