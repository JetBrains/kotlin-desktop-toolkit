...
use windows::Win32::UI::WindowsAndMessaging::{
    FE_FONTSMOOTHINGORIENTATIONBGR, FE_FONTSMOOTHINGORIENTATIONRGB, FE_FONTSMOOTHINGCLEARTYPE,
    FE_FONTSMOOTHINGSTANDARD,
    SPI_GETFONTSMOOTHING,
    SPI_GETFONTSMOOTHINGCONTRAST, SPI_GETFONTSMOOTHINGORIENTATION, SPI_GETFONTSMOOTHINGTYPE,
