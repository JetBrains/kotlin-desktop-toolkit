...
pub(crate) struct KeyEventInfo {
    ...
    // e.g., for F1 it will be the value of `NSF1FunctionKey` constant.
    // For dead keys it will be empty.
    pub(crate) characters: Retained<NSString>,

    // Same as characters but ignoring modifiers (except Shift and Option?)
