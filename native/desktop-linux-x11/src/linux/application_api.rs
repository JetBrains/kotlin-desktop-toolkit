...
use crate::linux::application_state::{EglInstance, get_egl};
use crate::linux::events::{EventHandler, RequestId, WindowId};
...
#[unsafe(no_mangle)]
pub extern "C" fn application_clipboard_put(app_ptr: AppPtr, mime_types: BorrowedStrPtr) {
...
#[unsafe(no_mangle)]
pub extern "C" fn application_primary_selection_put(app_ptr: AppPtr, mime_types: BorrowedStrPtr) {
