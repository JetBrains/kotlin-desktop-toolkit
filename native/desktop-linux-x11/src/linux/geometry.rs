...
impl LogicalPoint {
    #[must_use]
    pub fn as_winit_position(&self) -> dpi::Position {
...
impl LogicalSize {
    ...
    #[must_use]
    pub fn as_winit_size(&self) -> dpi::Size {
...
impl PhysicalRect {
    ...
    #[must_use]
    pub fn as_size(&self) -> PhysicalSize {
        PhysicalSize {
            width: self.width,
            height: self.height,
        }
...
impl LogicalRect {
    ...
    #[must_use]
    pub fn as_size(&self) -> LogicalSize {
        LogicalSize {
            width: self.width,
            height: self.height,
        }
    ...
    #[must_use]
    pub fn as_winit_position(&self) -> dpi::LogicalPosition<f64> {
        dpi::LogicalPosition { x: self.x.0, y: self.y.0 }
    }

    #[must_use]
    pub fn as_winit_size(&self) -> dpi::LogicalSize<f64> {
        dpi::LogicalSize {
            width: self.width.0,
            height: self.height.0,
        }
