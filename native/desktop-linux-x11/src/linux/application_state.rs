...
use crate::linux::geometry::{LogicalPoint, LogicalRect, round_to_u32};
...
use winit_core::event_loop::{ActiveEventLoop, EventLoopProxy};
            ...
            match event {
                ...
                WindowEvent::Ime(ime) => match ime {
                    ...
                    Ime::Preedit(text, pos) => {
                        ...
                        let (cursor_begin_byte_pos, cursor_end_byte_pos) = pos.map(|(a, b)| (a as i32, b as i32)).unwrap_or((-1, -1));
